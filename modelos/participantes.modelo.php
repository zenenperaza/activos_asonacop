...
class ModeloParticipantes{
	...
	static public function mdlMostrarParticipantes($tabla, $item, $valor, $orden){
	...
	static public function mdlIngresarActivo($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(id_categoria, codigo, codigo_uf, descripcion, fecha_adquisicion, fuente_financiamiento, origen_activo, situacion_contable, ubicacion_fisica, responsable, fecha_entrega_res, estado_conservacion, info_garantia, observaciones ,imagen, stock, precio_compra_bs, precio_compra_ds) VALUES (:id_categoria, :codigo, :codigo_uf, :descripcion, :fecha_adquisicion, :fuente_financiamiento, :origen_activo, :situacion_contable, :ubicacion_fisica, :responsable, :fecha_entrega_res, :estado_conservacion,:info_garantia, :observaciones , :imagen, :stock, :precio_compra_bs, :precio_compra_ds)");
	...
	static public function mdlEliminarParticipante($tabla, $datos){
