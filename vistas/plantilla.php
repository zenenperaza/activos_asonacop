...
<head>
  ...
  <title>ASONACOP | Gestión interna</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <link rel="shortcut icon" href="vistas/img/plantilla/favicon.png"/>
  <!--=====================================
  PLUGINS DE CSS
  ======================================-->
  ...
  <link href='vistas/fonts/fonts.css' rel='stylesheet' type='text/css'> 
 ...
 <!-- DataTables -->
  ...
  <script src="vistas/bower_components/datatables/dataTables.buttons.min.js"></script>
  <script src="vistas/bower_components/datatables/buttons.html5.min.js"></script>
  <script src="vistas/bower_components/datatables/buttons.colVis.min.js"></script>
  <script src="vistas/bower_components/datatables/jszip.min.js"></script>
  <script src="vistas/bower_components/datatables/pdfmake.min.js"></script>
  <script src="vistas/bower_components/datatables/vfs_fonts.js"></script> 
   ...
   echo '<div class="wrapper">';
    ...
    if(isset($_GET["ruta"])){
      ...
      if($_GET["ruta"] == "inicio" ||
         ...
         $_GET["ruta"] == "crear-asignacion" ||
         $_GET["ruta"] == "editar-asignacion" ||
         $_GET["ruta"] == "reportes" ||
         $_GET["ruta"] == "participantes" ||
